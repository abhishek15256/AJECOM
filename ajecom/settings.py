"""
Django settings for ajecom project.
...
WSGI_APPLICATION = 'ajecom.wsgi.application'
...
AWS_ACCESS_KEY_ID = ('AKIAVXRX4KLJG7CIUGAZ')
AWS_SECRET_ACCESS_KEY = ('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')
